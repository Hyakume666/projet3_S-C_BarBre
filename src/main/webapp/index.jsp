                            ...
                            <% for (StationMeteo station : stations) { %>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<%= application.getContextPath() %>/supprimer-station?id=<%= station.getNumero() %>" 
                                           class="btn btn-sm btn-outline-danger" title="Supprimer"
                                           onclick="return confirm('Voulez-vous vraiment supprimer la station <%= station.getNom() %> ?');">
